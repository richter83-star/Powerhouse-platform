...
def launch_dashboard():
    import subprocess
    import os
    os.chdir('core/robustness/dashboard')
...
def main():
    ...
    # Initialize RedTeamSandbox for security testing
    red_team = RedTeamSandbox()
    print("✅ RedTeamSandbox initialized for security testing")
    ...
    try:
        ...
        launch_dashboard()
        print("✅ Dashboard server launched")
